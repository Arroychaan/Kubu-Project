...
import 'widgets/auth_barrier_dialog.dart';
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              ...
              // Subtle cyan hint at the bottom right
              AppTheme.kubuCyan.withValues(alpha: 0.05),
            ],
          ),
        ),
        child: SafeArea(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Text(
                          'KUBU',
                          style: TextStyle(
                            fontFamily: 'Courier', // Tech mono feel or fallback
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 10,
                            letterSpacing: 3,
                            color: AppTheme.kubuCyan.withValues(alpha: 0.7),
                    ...
                    // Profile Icon with subtle glow
                    Container(
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        boxShadow: [
                          BoxShadow(
                            color: AppTheme.kubuCyan.withValues(alpha: 0.2),
                            blurRadius: 10,
                          ),
                        ],
                      ),
                      child: CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            // ... (Existing logic) matches below
                            final auth = Get.find<AuthController>();
                            if (auth.user.value == null) {
                              Get.bottomSheet(
                                const AuthBarrierDialog(),
